...
if test "x$want_msp" = "xyes"; then
        ...
        if test "$ac_msp_path" != ""; then
            MSP_LIBS="-R$ac_msp_path/lib -L$ac_msp_path/lib  -ldl -R$ac_msp_path/lib -L$ac_msp_path/lib -lMSPCoordinateConversionService -lMSPCovarianceService -lMSPImagingGeometryService -lMSPMensurationService -lMSPMensurationSessionRecordService -lMSPPointExtractionService -lMSPOutputMethodService -lMSPSensorModelService -lMSPSensorSpecificService -lMSPSupportDataService -lMSPTerrainService -lMSPlunar -lMSPasdetre -lMSPCCSUtils -lMSPcoordconverter -lMSPcsisd -lMSPcsm -lMSPcsmutil -lMSPDEIUtil -lMSPgeometry -lMSPjson -lMSPlas -lMSPmath -lMSPnitf -lMSPntmtre -lMSPrage -lMSPRageServiceUtils -lMSPrageutilities -lMSPSScovmodel -lMSPSSrutil -lMSPutilities -lMSPmiisd"
            MSP_CFLAGS="-I$ac_msp_path/include -I$ac_msp_path/include/CCSUtils -I$ac_msp_path/include/CoordinateConversion -I$ac_msp_path/include/Covariance -I$ac_msp_path/include/PointExtraction -I$ac_msp_path/include/ImagingGeometry -I$ac_msp_path/include/Mensuration -I$ac_msp_path/include/MensurationSessionRecord -I$ac_msp_path/include/OutputMethod -I$ac_msp_path/include/SensorModel -I$ac_msp_path/include/SupportData -I$ac_msp_path/include/Terrain -I$ac_msp_path/include/common -I$ac_msp_path/include/common/csm -I$ac_msp_path/include/common/csmutil -I$ac_msp_path/include/common/dtcc -I$ac_msp_path/include/common/geometry -I$ac_msp_path/include/common/math -I$ac_msp_path/include/common/ntmtre -I$ac_msp_path/include/common/miisd -I$ac_msp_path/include/common/nitf -I$ac_msp_path/include/common/utilities"
		...
		MSP_CFLAGS="-I$ac_path_tmp/include -I$ac_path_tmp/include/CCSUtils -I$ac_path_tmp/include/CoordinateConversion -I$ac_path_tmp/include/Covariance -I$ac_path_tmp/include/PointExtraction -I$ac_path_tmp/include/ImagingGeometry -I$ac_path_tmp/include/Mensuration -I$ac_path_tmp/include/MensurationSessionRecord -I$ac_path_tmp/include/OutputMethod -I$ac_path_tmp/include/SensorModel -I$ac_path_tmp/include/SupportData -I$ac_path_tmp/include/Terrain -I$ac_path_tmp/include/common -I$ac_path_tmp/include/common/csm -I$ac_path_tmp/include/common/csmutil -I$ac_path_tmp/include/common/dtcc -I$ac_path_tmp/include/common/geometry -I$ac_path_tmp/include/common/math -I$ac_path_tmp/include/common/ntmtre -I$ac_path_tmp/include/common/miisd -I$ac_path_tmp/include/common/nitf -I$ac_path_tmp/include/common/utilities"
