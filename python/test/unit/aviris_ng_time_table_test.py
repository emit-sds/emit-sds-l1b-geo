from .aviris_ng_time_table import *
...
@slow
def test_aviris_ng_time_table(aviris_pps_fname, aviris_raw_fname,
                              isolated_dir):
    ...
    # data from
    assert abs(tt.pps_table.clock_to_time(1777609046) - geocal.Time.parse_time("2017-03-28T20:21:02.095971Z")) < 1e-6
    assert abs(tt.pps_table.clock_to_time(1786609377) - geocal.Time.parse_time("2017-03-28T20:22:32.099810Z")) < 1e-6
