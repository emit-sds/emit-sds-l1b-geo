...
def test_sto_file():
    '''Read a sto file'''
    f = StoFile(unit_test_data + "oco3_issbad_210930000000_210930020000_211005113331_hsc.sto")
    print(len(f.orbit_data))

def test_create_orbit(isolated_dir):
    ...
    # are consistent.
    f = h5py.File(unit_test_data +
                  "oco3_L0AEP_13628_210930_B10305r_211124062049.h5", "r")
    ...
    print("Note that the quaternion will be different. OCO converts this to is SRU frame. But time and position match")
