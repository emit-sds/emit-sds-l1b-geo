...
#define SWIGTYPE_p_boost__shared_ptrT_Emit__EmitObsCalc_t swig_types[138]
...
SWIGINTERN PyObject *_wrap_new_EmitObsCalc(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "new_EmitObsCalc", 6, 6, swig_obj)) SWIG_fail;
  {
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_EmitObsCalc" "', argument " "1"" of type '" "GeoCal::ImageGroundConnection const &""'"); 
      }
