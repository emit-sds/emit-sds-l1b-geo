...
/****************************************************************//**
  ...
  probably should move this to GeoCal proper. But for right now we'll
  keep this separate, I don't want to force an update of geocal until
  we have a bit of slack in the schedule - the anaconda builds can
...
BOOST_CLASS_EXPORT_KEY(Emit::Resampler);
#endif
