# This comes from https://github.com/mrocklin/multipolyfit.
# There is a pip package for this, but it really isn't maintained. This was
# just a response to a stackoverflow question. We just include the code
# directly here, rather than needing a new pip install.
#
# Sort of odd that there isn't already a package for this in scipy, but
# all that is there is a 1 variable polynomial fit (Polynomial.fit). I don't
# actually do this fits all that often, so it isn't really worth trying to
